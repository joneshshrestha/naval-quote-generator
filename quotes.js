export let quotesArray = [
    "t's never been easier to start a company. It's never been harder to build one.",
    "eading is more efficient when at rest. Audio is more efficient when in motion.",
    "our goal in life is to find out the people who need you the most, to find out the business that needs you the most, to find the project and the art that needs you the most. There is something out there just for you.",
    "eek wealth, not money or status. Wealth is having assets that earn while you sleep. Money is how we transfer time and wealth. Status is your place in the social hierarchy.",
    "ounders run every sprint as if they’re about to lose, but grind out the long race knowing that victory is inevitable.",
